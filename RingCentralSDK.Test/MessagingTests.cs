...
namespace RingCentralSDK.Test
{
    ...
    public class MessagingTests : TestConfiguration
    {
        ...
        public void DeleteMessage()
        {
            ...
            //TODO: messages appear to expire after a while, need to create a message and then delete
        ...
        public void GetSingleMessage()
        {
            ...
            JToken token = JObject.Parse(result);
            var messageStore = (string)token.SelectToken("records")[0].SelectToken("id");
        ...
        public void SendSms()
        {
            ...
            var smsHelper = new SmsHelper(SmsNumber, UserName, smsText);
        ...
        {
            const string messageStore = "1182185004";
